...
export type FiltrosColunaFornecedoresState = {
	nome: string;
	razaosocial: string;
	cnpjcpf: string;
	endereco: string;
...
export const filtrosColunaFornecedoresVazios: FiltrosColunaFornecedoresState = {
	nome: "",
	razaosocial: "",
	cnpjcpf: "",
	endereco: "",
...
export type ConfigFiltroColunaFornecedor = {
	tipo: TipoFiltroColunaTabela;
	opcoes?: OpcaoFiltroColunaTabela[];
	placeholder?: string;
};

type DefinicaoColunaFornecedor = {
	id: string;
	label: string;
...
const DEFINICOES_COLUNAS: DefinicaoColunaFornecedor[] = [
...
export function visibilidadePadraoColunasFornecedores(): VisibilityState {
...
export function criarColunasFornecedores(
	opcoes: OpcoesColunasFornecedores,
): ColumnDef<Entidade>[] {
