				...
				<div className="space-y-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<Field data-invalid={!!errors.idbanco}>
							...
							<Select
								value={
									watch("idbanco") !== undefined && watch("idbanco") !== null
										? watch("idbanco").toString()
										: undefined
								}
								onValueChange={(value) =>
									setValue("idbanco", value ? Number(value) : undefined)
								}
							>
								<SelectTrigger
									id="idbanco"
						...
						<Field data-invalid={!!errors.identidade}>
							...
							<Select
								value={watch("identidade") || undefined}
								onValueChange={(value) =>
									setValue("identidade", value || undefined)
								}
							>
								<SelectTrigger
									id="identidade"
									aria-invalid={!!errors.identidade}
									aria-describedby={
										errors.identidade ? "identidade-error" : undefined
									}
								>
						...
						<Field data-invalid={!!errors.idplanocontas}>
							...
							<Select
								value={watch("idplanocontas") || undefined}
								onValueChange={(value) =>
									setValue("idplanocontas", value || undefined)
								}
							>
								<SelectTrigger
									id="idplanocontas"
						...
						<Field data-invalid={!!errors.iddependente}>
							<FieldLabel htmlFor="iddependente">Dependente</FieldLabel>
							<Input
								id="iddependente"
								type="number"
								placeholder="ID do dependente"
								aria-invalid={!!errors.iddependente}
								aria-describedby={
									errors.iddependente ? "iddependente-error" : undefined
								}
								{...register("iddependente", { valueAsNumber: true })}
							/>
							<FieldError
								errors={errors.iddependente ? [errors.iddependente] : []}
							/>
						</Field>

						<Field data-invalid={!!errors.idportador}>
							<FieldLabel htmlFor="idportador">Portador</FieldLabel>
							<Input
								id="idportador"
								type="number"
								placeholder="ID do portador"
								aria-invalid={!!errors.idportador}
								aria-describedby={
									errors.idportador ? "idportador-error" : undefined
								}
								{...register("idportador", { valueAsNumber: true })}
							/>
							<FieldError
								errors={errors.idportador ? [errors.idportador] : []}
							/>
						</Field>
					</div>
				</div>
