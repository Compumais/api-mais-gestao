		...
		<FieldGroup>
			<Tabs defaultValue="classificacao" className="w-full">
				...
				>
					...
					<section className="space-y-4">
						<h3 className="text-base font-semibold">Alíquotas ICMS</h3>
						<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
							<CampoPercentual
				...
				>
					<section className="space-y-4">
						<h3 className="text-base font-semibold">Substituição tributária</h3>
						<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
							<CampoPercentual
								id="percentualmva"
								label="MVA (%)"
				...
				>
					<section className="space-y-4">
						<h3 className="text-base font-semibold">DIFAL</h3>
						<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
							<CampoPercentual
				...
				>
					<section className="space-y-4">
						<h3 className="text-base font-semibold">CST PIS / COFINS</h3>
						<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
							<Controller
								name="cstpisentrada"
								control={control}
					...
					<section className="space-y-4">
						<h3 className="text-base font-semibold">Alíquotas PIS / COFINS</h3>
						<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
							<CampoPercentual
								id="aliquotapis"
								label="PIS saída"
				...
				>
					<section className="space-y-4">
						<h3 className="text-base font-semibold">ISS</h3>
						<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
							<CampoPercentual
								id="aliquotaiss"
								label="ISS"
