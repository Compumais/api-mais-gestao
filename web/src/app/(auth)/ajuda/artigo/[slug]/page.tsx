		...
		<div className="container mx-auto max-w-4xl px-4 py-8">
			...
			<article className="mb-12">
				...
				<div className="prose prose-slate max-w-none dark:prose-invert">
					<p className="lead">
						Neste guia, você aprenderá como cadastrar uma nova conta a pagar no
						Mais Gestão de forma rápida e simples.
					</p>

					<h2>1. Acessando o módulo de Contas a Pagar</h2>
					<p>
						Para começar, acesse o menu lateral e clique em{" "}
						<strong>Contas a Pagar</strong>. Você será direcionado para a lista
					...
					<p>
						...
						<strong>Nova Conta a Pagar</strong>. Um formulário será exibido com
						os seguintes campos:
					</p>
					...
					<ul>
						...
						<li>
							<strong>Descrição:</strong> Informe uma descrição clara da despesa
						</li>
						<li>
						...
						<li>
							<strong>Plano de Contas:</strong> Categorize a despesa no plano de
							contas
						</li>
					</ul>
					...
					<div className="not-prose my-8 rounded-lg border-l-4 border-primary bg-primary/5 p-4">
						<p className="mb-0 text-sm">
							<strong>💡 Dica:</strong> Você pode criar contas recorrentes para
							despesas que se repetem mensalmente, como aluguel e contas de
							serviços.
						</p>
					</div>

					<h2>Próximos passos</h2>
					<p>Agora que você criou sua primeira conta a pagar, aprenda como:</p>
					<ul>
