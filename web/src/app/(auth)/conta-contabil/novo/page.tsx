                    ...
                    <FieldGroup>
                        <div className="grid grid-cols-3 w-full items-start gap-4">
                            ...
                            <Field data-invalid={!!errors.natureza}>
                                ...
                                <FieldError
                                    errors={errors.natureza ? [errors.natureza] : []}
                                />
                            </Field>
                        ...
                        <div className="grid grid-cols-3 w-full items-start gap-4">
                            <Field data-invalid={!!errors.codigoreduzido}>
                                ...
                                <FieldError
                                    errors={
                                        errors.codigoreduzido ? [errors.codigoreduzido] : []
                                    }
                                />
                            </Field>
                            ...
                            <Field data-invalid={!!errors.codigoextenso}>
                                ...
                                <FieldError
                                    errors={
                                        errors.codigoextenso ? [errors.codigoextenso] : []
                                    }
                                />
                            </Field>
                        </div>
