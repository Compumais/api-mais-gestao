...
const MovimentacaoFormContext =
	React.createContext<MovimentacaoFormContextType | null>(null);
...
export function useMovimentacaoForm() {
	...
	if (!context) {
		throw new Error(
			"useMovimentacaoForm must be used within MovimentacaoFormProvider",
		);
	}
	return context;
}
