/**
 * Heurísticas de coerência CFOP de entrada × tributação (espelho da API).
 * ST entrada: 2º dígito = 4. Tributado mercadoria: 2º dígito = 1.
 */
...
export function mensagemInconsistenciaCfopEntrada(
	...
	switch (tipo) {
		case "cfop_obrigatorio":
			return "Informe o CFOP de entrada";
		case "cfop_nao_entrada":
			return "CFOP deve ser de entrada (1/2/3)";
		case "st_com_cfop_tributado":
			return "Item com ST exige CFOP ST (ex. 1403)";
		case "tributado_com_cfop_st":
			return "Item sem ST não deve usar CFOP ST";
		default:
			return "CFOP inconsistente";
	}
}
