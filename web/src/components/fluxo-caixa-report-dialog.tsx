...
export function FluxoCaixaReportDialog({
	open,
	onOpenChange,
}: FluxoCaixaReportDialogProps) {
	...
	const gerarRelatorioMutation = useMutation({
		mutationFn: async () => {
			...
			await gerarRelatorioFluxoCaixa({
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-[500px]">
				<DialogHeader>
					<DialogTitle>Gerar Relatório de Fluxo de Caixa</DialogTitle>
					<DialogDescription>
				...
				<FieldGroup>
					...
					<Field>
						<FieldLabel htmlFor="formato">Formato do Relatório *</FieldLabel>
						<Select
							value={formato}
							onValueChange={(value) =>
