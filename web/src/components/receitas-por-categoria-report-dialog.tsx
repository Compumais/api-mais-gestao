...
export function ReceitasPorCategoriaReportDialog({
	open,
	onOpenChange,
}: ReceitasPorCategoriaReportDialogProps) {
	...
	const gerarRelatorioMutation = useMutation({
		mutationFn: async () => {
			...
			await gerarRelatorioReceitasPorCategoria({
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-[500px]">
				<DialogHeader>
					<DialogTitle>Gerar Relatório de Receitas por Categoria</DialogTitle>
					<DialogDescription>
				...
				<FieldGroup>
					<Field>
						<FieldLabel htmlFor="rpc-dataInicio">Data Inicial *</FieldLabel>
						<Input
							id="rpc-dataInicio"
							type="date"
					...
					<Field>
						<FieldLabel htmlFor="rpc-dataFim">Data Final *</FieldLabel>
						<Input
							id="rpc-dataFim"
							type="date"
