...
export function InadimplenciaReportDialog({
	open,
	onOpenChange,
}: InadimplenciaReportDialogProps) {
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-[500px]">
				<DialogHeader>
					<DialogTitle>Gerar Relatório de Inadimplência</DialogTitle>
					<DialogDescription>
				...
				<FieldGroup>
					<Field>
						<FieldLabel htmlFor="inad-dataInicio">Data Inicial *</FieldLabel>
						<Input
							id="inad-dataInicio"
							type="date"
					...
					<Field>
						<FieldLabel htmlFor="inad-dataFim">Data Final *</FieldLabel>
						<Input
							id="inad-dataFim"
							type="date"
					...
					<Field>
						<FieldLabel htmlFor="inad-formato">
