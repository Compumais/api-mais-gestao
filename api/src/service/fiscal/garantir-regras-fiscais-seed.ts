...
/**
 * Garante regras operacionais MG (ST interna CFOP 54xx) no banco.
 * Idempotente — equivalente à migration 0082, útil quando a migration ainda não rodou.
 */
export async function garantirRegrasFiscaisOperacionaisSeed(): Promise<void> {
