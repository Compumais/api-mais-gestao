...
export const buscarAreaSchema: FastifySchema = {
	tags: ["areas"],
	summary: "Buscar área por ID",
	description: "Retorna os dados de um registro de área.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
...
export const listarAreasSchema: FastifySchema = {
	tags: ["areas"],
	summary: "Listar áreas",
	description: "Lista registros de áreas com paginação.",
	security: [{ bearerAuth: [] }],
	querystring: {
		type: "object",
		properties: {
...
export const atualizarAreaSchema: FastifySchema = {
	tags: ["areas"],
	summary: "Atualizar área",
	description: "Atualiza um registro de área.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
...
export const excluirAreaSchema: FastifySchema = {
	tags: ["areas"],
	summary: "Excluir área",
	description: "Exclui um registro de área.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
