...
export const atualizarIntegracaoContabilConfiguracaoSchema: FastifySchema = {
	tags: ["integracoes-contabil-configuracao"],
	summary: "Atualizar integração contábil configuração",
	description: "Atualiza um registro de integração contábil configuração.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
...
export const excluirIntegracaoContabilConfiguracaoSchema: FastifySchema = {
	tags: ["integracoes-contabil-configuracao"],
	summary: "Excluir integração contábil configuração",
	description: "Exclui um registro de integração contábil configuração.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
