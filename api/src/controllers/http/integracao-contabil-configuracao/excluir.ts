...
import z from "zod";
import { excluirIntegracaoContabilConfiguracaoService } from "@/service/integracao-contabil-configuracao/excluir-integracao-contabil-configuracao.js";
import { httpErroInterno, httpNaoAutorizado } from "@/util/http-util.js";

const excluirIntegracaoContabilConfiguracaoParamsSchema = z.object({
	id: z.string(),
});
