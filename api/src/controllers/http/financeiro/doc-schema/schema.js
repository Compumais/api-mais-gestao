export const criarFinanceiroSchema = {
    ...
    description: "Cria um novo registro financeiro na empresa do usuário autenticado.",
    security: [{ bearerAuth: [] }],
    body: {
        type: "object",
        properties: {
...
export const buscarFinanceiroSchema = {
    ...
    description: "Retorna os dados completos de um registro financeiro específico",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
...
export const listarFinanceirosSchema = {
    ...
    description: "Lista todos os registros financeiros das empresas do usuário autenticado com paginação e filtros opcionais",
    security: [{ bearerAuth: [] }],
    querystring: {
        type: "object",
        properties: {
