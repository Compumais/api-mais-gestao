export const criarFinanceiroLancamentoSchema = {
    tags: ["financeiro-lancamentos"],
    summary: "Criar novo lançamento financeiro",
    description: "Cria um novo lançamento financeiro. O lançamento é associado a um financeiro existente.",
    security: [{ bearerAuth: [] }],
    body: {
        type: "object",
        properties: {
...
export const buscarFinanceiroLancamentoSchema = {
    tags: ["financeiro-lancamentos"],
    summary: "Buscar lançamento financeiro por ID",
    description: "Retorna os dados completos de um lançamento financeiro específico",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
...
export const listarFinanceiroLancamentoSchema = {
    tags: ["financeiro-lancamentos"],
    summary: "Listar lançamentos financeiros",
    description: "Lista os lançamentos financeiros de um financeiro específico com paginação. Retorna uma lista paginada com os dados dos lançamentos.",
    security: [{ bearerAuth: [] }],
    querystring: {
        type: "object",
        properties: {
...
export const atualizarFinanceiroLancamentoSchema = {
    tags: ["financeiro-lancamentos"],
    summary: "Atualizar lançamento financeiro",
    description: "Atualiza os dados de um lançamento financeiro existente. Apenas os campos fornecidos serão atualizados.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
...
export const excluirFinanceiroLancamentoSchema = {
    tags: ["financeiro-lancamentos"],
    summary: "Excluir lançamento financeiro",
    description: "Exclui um lançamento financeiro existente. Esta ação não pode ser desfeita.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
