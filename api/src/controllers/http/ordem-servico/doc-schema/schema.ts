...
export const listarOrdemServicosSchema: FastifySchema = {
	...
	querystring: {
		...
		properties: {
			...
			idultimotecnico: { type: "string" },
			idatendente: { type: "string" },
			idobjeto: { type: "string" },
			idarea: { type: "string" },
			idtipoproblema: { type: "string" },
			codigo: { type: "number" },
			orcamento: { type: "number" },
			dataInicio: { type: "string" },
			dataFim: { type: "string" },
			busca: { type: "string" },
			cnpjcpfcliente: { type: "string" },
			geroufinanceiro: { type: "number" },
			faturouparanota: { type: "number" },
			faturouparacupom: { type: "number" },
			agendamento: { type: "string" },
			previsaoconclusao: { type: "string" },
			dataultimoevento: { type: "string" },
			problemadescrito: { type: "string" },
			laudotecnico: { type: "string" },
			observacao: { type: "string" },
			descricaotipoultimoevento: { type: "string" },
			descricaoultimoevento: { type: "string" },
			placa: { type: "string" },
			marca: { type: "string" },
			modelo: { type: "string" },
			renavam: { type: "string" },
			ordenarPor: {
				type: "string",
				description: "Campo da whitelist para ordenação",
			},
