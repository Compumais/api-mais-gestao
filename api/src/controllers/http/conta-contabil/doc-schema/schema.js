export const criarContaContabilSchema = {
    tags: ["conta-contabil"],
    summary: "Criar nova conta contábil",
    description: "Cria uma nova conta contábil na empresa do usuário autenticado.",
    security: [{ bearerAuth: [] }],
    body: {
        type: "object",
        properties: {
...
export const buscarContaContabilSchema = {
    tags: ["conta-contabil"],
...
export const listarContasContabeisSchema = {
    tags: ["conta-contabil"],
    summary: "Listar contas contábeis",
    description: "Lista as contas contábeis de uma empresa com paginação e filtro por descrição.",
    security: [{ bearerAuth: [] }],
    querystring: {
        type: "object",
        properties: {
...
export const atualizarContaContabilSchema = {
    tags: ["conta-contabil"],
    summary: "Atualizar conta contábil",
    description: "Atualiza os dados de uma conta contábil existente. Apenas os campos fornecidos serão atualizados.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
...
export const excluirContaContabilSchema = {
    tags: ["conta-contabil"],
    summary: "Excluir conta contábil",
    description: "Exclui uma conta contábil existente. Uma auditoria é registrada antes da exclusão.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
