...
export const buscarCentroCustoSchema: FastifySchema = {
	tags: ["centros-custo"],
	summary: "Buscar centro de custo por ID",
	description: "Retorna os dados de um registro de centro de custo.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
...
export const listarCentroCustosSchema: FastifySchema = {
	tags: ["centros-custo"],
	summary: "Listar centros de custo",
	description: "Lista registros de centros de custo com paginação.",
	security: [{ bearerAuth: [] }],
	querystring: {
		type: "object",
		properties: {
...
export const atualizarCentroCustoSchema: FastifySchema = {
	tags: ["centros-custo"],
	summary: "Atualizar centro de custo",
	description: "Atualiza um registro de centro de custo.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
...
export const excluirCentroCustoSchema: FastifySchema = {
	tags: ["centros-custo"],
	summary: "Excluir centro de custo",
	description: "Exclui um registro de centro de custo.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
