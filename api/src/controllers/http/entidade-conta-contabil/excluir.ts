...
import z from "zod";
import { excluirEntidadeContaContabilService } from "@/service/entidade-conta-contabil/excluir-entidade-conta-contabil.js";
import { httpErroInterno, httpNaoAutorizado } from "@/util/http-util.js";

const excluirEntidadeContaContabilParamsSchema = z.object({
	id: z.string(),
});
