...
import z from "zod";
import { excluirPlanoContasContaContabilService } from "@/service/plano-contas-conta-contabil/excluir-plano-contas-conta-contabil.js";
import { httpErroInterno, httpNaoAutorizado } from "@/util/http-util.js";

const excluirPlanoContasContaContabilParamsSchema = z.object({
	id: z.string(),
});
