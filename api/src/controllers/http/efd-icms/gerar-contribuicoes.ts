...
import z from "zod";
import { gerarEfdContribuicoesService } from "@/service/efd-contribuicoes/gerar-efd-contribuicoes.service.js";
...
export async function gerarEfdContribuicoes(
	...
	try {
		...
		const resultado = await gerarEfdContribuicoesService({
