...
export const buscarCondicaoPagamentoSchema: FastifySchema = {
	tags: ["condicoes-pagamento"],
	summary: "Buscar condição de pagamento por ID",
	description: "Retorna os dados de um registro de condição de pagamento.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
...
export const listarCondicaoPagamentosSchema: FastifySchema = {
	tags: ["condicoes-pagamento"],
	summary: "Listar condições de pagamento",
	description: "Lista registros de condições de pagamento com paginação.",
	security: [{ bearerAuth: [] }],
	querystring: {
		type: "object",
		properties: {
...
export const atualizarCondicaoPagamentoSchema: FastifySchema = {
	tags: ["condicoes-pagamento"],
	summary: "Atualizar condição de pagamento",
	description: "Atualiza um registro de condição de pagamento.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
...
export const excluirCondicaoPagamentoSchema: FastifySchema = {
	tags: ["condicoes-pagamento"],
	summary: "Excluir condição de pagamento",
	description: "Exclui um registro de condição de pagamento.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
