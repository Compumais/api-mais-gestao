...
export async function deletarChaveApi(request, reply) {
    try {
        if (!request.user) {
        ...
        const integracao = configuracao.integracao || { apis: { chaves: [] } };
        const chaves = integracao.apis?.chaves || [];
        const chavesFiltradas = chaves.filter((chave) => chave.id !== params.chaveId);
...
//# sourceMappingURL=deletar-chave-api.js.map