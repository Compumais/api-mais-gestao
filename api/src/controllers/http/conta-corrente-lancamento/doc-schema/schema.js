export const criarContaCorrenteLancamentoSchema = {
    tags: ["conta-corrente-lancamentos"],
    summary: "Criar novo lançamento de conta corrente",
    description: "Cria um novo lançamento de conta corrente. O saldo é calculado automaticamente com base no tipo de operação (Entrada/Saída).",
    security: [{ bearerAuth: [] }],
    body: {
        type: "object",
        properties: {
...
export const buscarContaCorrenteLancamentoSchema = {
    tags: ["conta-corrente-lancamentos"],
...
export const listarContaCorrenteLancamentoSchema = {
    tags: ["conta-corrente-lancamentos"],
    summary: "Listar lançamentos de conta corrente",
    description: "Lista os lançamentos de uma conta corrente específica com paginação. Retorna uma lista paginada com os dados dos lançamentos incluindo relacionamentos.",
    security: [{ bearerAuth: [] }],
    querystring: {
        type: "object",
        properties: {
...
export const atualizarContaCorrenteLancamentoSchema = {
    tags: ["conta-corrente-lancamentos"],
    summary: "Atualizar lançamento de conta corrente",
    description: "Atualiza os dados de um lançamento existente. Apenas os campos fornecidos serão atualizados.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
...
export const excluirContaCorrenteLancamentoSchema = {
    tags: ["conta-corrente-lancamentos"],
    summary: "Excluir lançamento de conta corrente",
    description: "Exclui um lançamento existente. Uma auditoria é registrada antes da exclusão para manter o histórico.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
