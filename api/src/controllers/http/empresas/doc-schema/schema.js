export const criarEmpresaSchema = {
    tags: ["empresas"],
    summary: "Criar nova empresa",
    description: "Cria uma nova empresa associada ao usuário autenticado. O usuário se torna o proprietário da empresa. Verifica limites de empresas por usuário.",
    security: [{ bearerAuth: [] }],
    body: {
        type: "object",
        properties: {
...
export const buscarEmpresaSchema = {
    tags: ["empresas"],
    summary: "Buscar empresa por ID",
    description: "Retorna os dados completos de uma empresa específica. Esta rota não requer autenticação.",
    params: {
        type: "object",
        properties: {
            id: {
...
export const listarEmpresasSchema = {
    ...
    description: "Lista empresas com paginação e filtros opcionais. Permite filtrar por proprietário, nome, CNPJ ou telefone.",
    security: [{ bearerAuth: [] }],
    querystring: {
        type: "object",
        properties: {
...
export const atualizarEmpresaSchema = {
    tags: ["empresas"],
    summary: "Atualizar empresa",
    description: "Atualiza os dados de uma empresa existente. Apenas os campos fornecidos serão atualizados.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
...
export const excluirEmpresaSchema = {
    tags: ["empresas"],
    summary: "Excluir empresa",
    description: "Exclui uma empresa existente. Esta operação é irreversível e remove todos os dados associados à empresa.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
