import z from "zod";
import { buscarUltimasMovimentacoesService } from "@/service/dashboard/buscar-ultimas-movimentacoes";
...
export async function buscarUltimasMovimentacoes(request, reply) {
    try {
        if (!request.user) {
...
//# sourceMappingURL=buscar-ultimas-movimentacoes.js.map