...
import { buscarFinanceiroResumoService } from "@/service/dashboard/buscar-dados-dashboard.js";
...
export async function buscarFinanceiroResumo(
	...
	try {
		...
		const resultado = await buscarFinanceiroResumoService({
