...
import { buscarExecutivoDashboardService } from "@/service/dashboard/buscar-analytics-dashboard.js";
...
export async function buscarExecutivo(
	...
	try {
		...
		const resultado = await buscarExecutivoDashboardService({
