export const criarBancoSchema = {
    tags: ["bancos"],
    summary: "Criar novo banco",
    description: "Cria um novo banco na empresa do usuário autenticado. Após a criação, uma auditoria é registrada automaticamente.",
    security: [{ bearerAuth: [] }],
    body: {
        type: "object",
        properties: {
...
export const buscarBancoSchema = {
    tags: ["bancos"],
...
export const listarBancosSchema = {
    tags: ["bancos"],
    summary: "Listar bancos",
    description: "Lista os bancos de uma empresa específica com paginação. Retorna uma lista paginada com os dados dos bancos.",
    security: [{ bearerAuth: [] }],
    querystring: {
        type: "object",
        properties: {
...
export const atualizarBancoSchema = {
    tags: ["bancos"],
    summary: "Atualizar banco",
    description: "Atualiza os dados de um banco existente. Apenas os campos fornecidos serão atualizados.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
...
export const excluirBancoSchema = {
    tags: ["bancos"],
    summary: "Excluir banco",
    description: "Exclui um banco existente. Uma auditoria é registrada antes da exclusão para manter o histórico.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
