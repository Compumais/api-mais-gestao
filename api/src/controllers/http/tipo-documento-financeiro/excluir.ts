...
import z from "zod";
import { excluirTipoDocumentoFinanceiroService } from "@/service/tipo-documento-financeiro/excluir-tipo-documento-financeiro.js";
import { httpErroInterno, httpNaoAutorizado } from "@/util/http-util.js";

const excluirTipoDocumentoFinanceiroParamsSchema = z.object({
	id: z.string(),
});
