...
export const atualizarTipoDocumentoFinanceiroSchema: FastifySchema = {
	tags: ["tipos-documento-financeiro"],
	summary: "Atualizar tipo de documento financeiro",
	description: "Atualiza um registro de tipo de documento financeiro.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
...
export const excluirTipoDocumentoFinanceiroSchema: FastifySchema = {
	tags: ["tipos-documento-financeiro"],
	summary: "Excluir tipo de documento financeiro",
	description: "Exclui um registro de tipo de documento financeiro.",
	security: [{ bearerAuth: [] }],
	params: {
		type: "object",
		properties: {
