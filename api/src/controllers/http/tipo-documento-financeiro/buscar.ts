...
import z from "zod";
import { buscarTipoDocumentoFinanceiroService } from "@/service/tipo-documento-financeiro/buscar-tipo-documento-financeiro.js";
import { httpErroInterno, httpNaoAutorizado } from "@/util/http-util.js";

const buscarTipoDocumentoFinanceiroParamsSchema = z.object({
	id: z.string(),
});
