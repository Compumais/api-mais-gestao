...
import z from "zod";
import { gerarRelatorioReceitasPorCategoria } from "@/services/relatorios/receitas-por-categoria.service.js";

const gerarRelatorioReceitasPorCategoriaSchema = z.object({
...
export async function gerarRelatorioReceitasPorCategoriaController(
	...
	try {
		...
		const body = gerarRelatorioReceitasPorCategoriaSchema.parse(request.body);
		...
		const resultado = await gerarRelatorioReceitasPorCategoria({
