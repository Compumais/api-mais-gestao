...
export async function gerarRelatorioInadimplenciaController(
	...
	try {
		...
		const body = gerarRelatorioInadimplenciaSchema.parse(request.body);
		...
		const resultado = await gerarRelatorioInadimplencia({
