...
import z from "zod";
import { gerarRelatorioContasReceber } from "@/services/relatorios/contas-receber.service.js";

const gerarRelatorioContasReceberSchema = z.object({
...
export async function gerarRelatorioContasReceberController(
	...
	try {
		...
		const body = gerarRelatorioContasReceberSchema.parse(request.body);
		...
		const resultado = await gerarRelatorioContasReceber({
