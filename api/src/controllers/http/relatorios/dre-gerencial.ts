...
const gerarRelatorioDreGerencialSchema = z.object({
...
export async function gerarRelatorioDreGerencialController(
	...
	try {
		...
		const body = gerarRelatorioDreGerencialSchema.parse(request.body);
		...
		const resultado = await gerarRelatorioDreGerencial({
