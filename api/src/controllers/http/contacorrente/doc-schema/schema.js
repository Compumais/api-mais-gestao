export const criarContaCorrenteSchema = {
    tags: ["contas-correntes"],
    summary: "Criar nova conta corrente",
    description: "Cria uma nova conta corrente na empresa do usuário autenticado. Após a criação, uma auditoria é registrada automaticamente.",
    security: [{ bearerAuth: [] }],
    body: {
        type: "object",
        properties: {
...
export const buscarContaCorrenteSchema = {
    tags: ["contas-correntes"],
...
export const listarContasCorrentesSchema = {
    tags: ["contas-correntes"],
    summary: "Listar contas correntes",
    description: "Lista as contas correntes de uma empresa específica com paginação. Retorna uma lista paginada com os dados básicos das contas.",
    security: [{ bearerAuth: [] }],
    querystring: {
        type: "object",
        properties: {
...
export const atualizarContaCorrenteSchema = {
    tags: ["contas-correntes"],
    summary: "Atualizar conta corrente",
    description: "Atualiza os dados de uma conta corrente existente. Apenas os campos fornecidos serão atualizados.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
...
export const excluirContaCorrenteSchema = {
    tags: ["contas-correntes"],
    summary: "Excluir conta corrente",
    description: "Exclui uma conta corrente existente. Uma auditoria é registrada antes da exclusão para manter o histórico.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
