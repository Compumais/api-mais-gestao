export const criarPlanoContasSchema = {
    tags: ["plano-contas"],
    summary: "Criar novo plano de contas",
    description: "Cria um novo plano de contas na empresa especificada. O plano de contas é usado para organizar as contas contábeis da empresa.",
    security: [{ bearerAuth: [] }],
    body: {
        type: "object",
        properties: {
            ...
            inativo: {
                type: "number",
                description: "Indica se o plano de contas está inativo (0 para ativo, 1 para inativo)",
            },
            classe: {
                type: "string",
                nullable: true,
...
export const buscarPlanoContasSchema = {
    tags: ["plano-contas"],
    summary: "Buscar plano de contas por ID",
    description: "Retorna os dados completos de um plano de contas específico. Verifica se o usuário tem acesso à empresa do plano de contas.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
...
export const listarPlanoContasSchema = {
    tags: ["plano-contas"],
    summary: "Listar planos de contas",
    description: "Lista os planos de contas das empresas do usuário autenticado com paginação e filtros. Permite filtrar por plano de contas pai e status (ativo/inativo).",
    security: [{ bearerAuth: [] }],
    querystring: {
        type: "object",
        properties: {
            ...
            inativo: {
                type: "boolean",
                description: "Filtrar por status (false para ativos, true para inativos)",
                default: false,
            },
            page: {
                type: "number",
...
export const atualizarPlanoContasSchema = {
    tags: ["plano-contas"],
    summary: "Atualizar plano de contas",
    description: "Atualiza os dados de um plano de contas existente. Apenas os campos fornecidos serão atualizados. Verifica permissões baseadas nos roles do usuário.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
...
export const excluirPlanoContasSchema = {
    tags: ["plano-contas"],
    summary: "Excluir plano de contas",
    description: "Exclui um plano de contas existente. Verifica permissões baseadas nos roles do usuário antes de permitir a exclusão.",
    security: [{ bearerAuth: [] }],
    params: {
        type: "object",
        properties: {
