import {
	buscarDadosContasPagar,
	type ContasPagarItem,
} from "@/repositories/relatorios-repositories.js";

export interface GerarRelatorioContasPagarParams {
	idempresa: string;
...
export async function gerarRelatorioContasPagar(
	params: GerarRelatorioContasPagarParams,
): Promise<{ content: string; contentType: string; filename: string }> {
	const dados = await buscarDadosContasPagar({
...
function gerarRelatorioTXT(
	...
	return {
		...
		filename: `contas-a-pagar-${params.dataInicio}-${params.dataFim}.txt`,
	};
}
...
<body>
  ...
  <table>
	...
	return {
		...
		filename: `contas-a-pagar-${params.dataInicio}-${params.dataFim}.html`,
	};
}
