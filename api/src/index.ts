...
import { budgetsRotas } from "./controllers/http/budgets/rotas.js";
...
import { cardapioDeliveryRotas } from "./controllers/http/cardapio-delivery/rotas.js";
...
import { cotacoesCompraRotas } from "./controllers/http/cotacoes-compra/rotas.js";
...
import { ibsCbsRotas } from "./controllers/http/ibscbs/rotas.js";
...
import { pedidosCompraRotas } from "./controllers/http/pedidos-compra/rotas.js";
...
import { tiposCobrancaRotas } from "./controllers/http/tipo-cobranca/rotas.js";
...
app.register(budgetsRotas);
app.register(cotacoesCompraRotas);
app.register(pedidosCompraRotas);
...
app.register(ibsCbsRotas);
app.register(gruposGourmetRotas);
app.register(cardapioDeliveryRotas);
...
app.register(tiposCobrancaRotas);
...
app.register(modeloImpressaoPedidoRotas);
