...
/**
 * Soma o desconto explícito de cada item com o rateio do desconto global.
 * O global usa a capacidade restante (bruto - desconto do item). O último
 * item com capacidade absorve o centavo restante. Nenhuma linha fica com
 * desconto efetivo maior que o bruto.
 */
