...
Write-Host ""
Write-Host "A API Fastify tambem serve /pdv/updates/ (PDV_UPDATES_PATH=$RemoteDir)."
Write-Host "Nginx location /pdv/updates/ e opcional; reinicie/deploy a API apos atualizar o manifesto embutido."
Write-Host "Opcional Nginx: sudo nginx -t && sudo systemctl reload nginx"
