/**
 * qrcode-generator 1.4.4 (MIT) — kazuhikoarase
...
var qrcode = (() => {
	...
	var r,
		...
		B =
			...
			(o.getBCHTypeNumber = (t) => {
				for (var r = t << 12; i(r) - i(n) >= 0; ) r ^= n << (i(r) - i(n));
				return (t << 12) | r;
			}),
			(o.getPatternPosition = (t) => r[t - 1]),
			(o.getMaskFunction = (t) => {
				switch (t) {
					case l:
						return (t, r) => (t + r) % 2 == 0;
					...
					case v:
						return (t, r) => (t + r) % 3 == 0;
					case d:
						return (t, r) => (Math.floor(t / 2) + Math.floor(r / 3)) % 2 == 0;
					case w:
						return (t, r) => ((t * r) % 2) + ((t * r) % 3) == 0;
					case p:
						return (t, r) => (((t * r) % 2) + ((t * r) % 3)) % 2 == 0;
					case y:
						return (t, r) => (((t * r) % 3) + ((t + r) % 2)) % 2 == 0;
					default:
						throw "bad maskPattern:" + t;
				}
			}),
			(o.getErrorCorrectPolynomial = (t) => {
				for (var r = k([1], 0), e = 0; e < t; e += 1)
					r = r.multiply(k([1, C.gexp(e)], 0));
				return r;
			}),
			(o.getLengthInBits = (t, r) => {
				if (1 <= r && r < 10)
					switch (t) {
						case a:
							return 10;
...
(qrcode.stringToBytesFuncs["UTF-8"] = (t) =>
	((t) => {
